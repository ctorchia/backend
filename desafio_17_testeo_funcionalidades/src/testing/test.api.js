...
describe('Test Completo de Funciones:', () => {
    ...
    describe('POST /api/productos', () => {
        ...
        it('Verificar datos de producto agregado', async () => {
            ...
            expect(parseInt(addedProduct.body.price)).to.eql(parseInt(productNew.price));
    ...
    describe('PUT /api/productos', () => {
        ...
        it('Actualizar producto:', async () => {
            let response = await request.put('/api/productos/' + 4).send(productUpdate);
            expect(response.status).to.eql(200);
        });
        ...
        it('Verificar datos de producto actualizado', async () => {
            ...
            expect(parseInt(updatedProduct.body.price)).to.eql(parseInt(productUpdate.price));
